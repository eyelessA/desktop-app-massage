    ...
    <div class="sm:flex items-center max-w-screen-xl">
        <div class="sm:w-1/2 p-10">
            <div class="image object-center text-center">
                <img src="https://avatars.mds.yandex.net/get-altay/10637174/2a0000018acd71feed66bef3a8707b50aada/XXL_height" class="rounded-lg">
            </div>
        </div>
        <div class="sm:w-1/2 p-5">
            <div class="text">
                ...
                <p class="text-gray-700">
                    Добро пожаловать в наш массажный центр! Мы — команда профессионалов, стремящихся дарить вам незабываемые моменты расслабления и восстановления. В нашем центре мы предлагаем широкий спектр массажных услуг, которые помогут вам снять напряжение, восстановить силы и улучшить общее самочувствие.

                    Каждый сеанс у нас — это не просто процедура, а настоящее путешествие в мир спокойствия и заботы о вашем теле и душе. Мы используем только лучшие техники и качественные материалы, чтобы каждый наш клиент почувствовал себя на высоте. В нашей команде работают опытные мастера, прошедшие обучение и имеющие глубокие знания в области массажа.

                    Мы уверены, что забота о себе — это залог здоровья и гармонии, поэтому делаем все, чтобы каждый визит к нам приносил максимальный результат и наслаждение.
                </p>
            </div>
        </div>
    </div>
